...
event_inherited();
obj_Chest.inventory.AddItem(global.vars.ItemLibrary.Pickaxe);
obj_Chest.inventory.AddItem(global.vars.ItemLibrary.RAM, 7);
obj_Chest.inventory.AddItem(global.vars.ItemLibrary.SandClumps, 5);
obj_Chest.inventory.AddItem(global.vars.ItemLibrary.SteelDebris, 2);
obj_Chest.inventory.AddItem(global.vars.ItemLibrary.ThermalGoo, 8);
obj_Chest.inventory.AddItem(global.vars.ItemLibrary.CircuitBlade, 1);
obj_Chest.inventory.AddItem(global.vars.ItemLibrary.GoldPlatedKnucles, 1);
obj_Chest.inventory.AddItem(global.vars.ItemLibrary.AluminumPipe, 1);
obj_Chest.inventory.AddItem(global.vars.ItemLibrary.SolderingIron, 1);
obj_Chest.inventory.AddItem(global.vars.ItemLibrary.GrapheneWhip, 1);
obj_Chest.inventory.AddItem(global.vars.ItemLibrary.CRTCannon, 1);
obj_Chest.inventory.AddItem(global.vars.ItemLibrary.RAMStickThrower, 1);
obj_Chest.inventory.AddItem(global.vars.ItemLibrary.CapacitorSlingshot, 1);
obj_Chest.inventory.AddItem(global.vars.ItemLibrary.AntiStaticJumpsuit, 1);
obj_Chest.inventory.AddItem(global.vars.ItemLibrary.GoldLinedCircuitVest, 1);
obj_Chest.inventory.AddItem(global.vars.ItemLibrary.AluminumPlating, 1);
obj_Chest.inventory.AddItem(global.vars.ItemLibrary.GrapheneWeaveSuit, 1);
obj_Chest.inventory.AddItem(global.vars.ItemLibrary.Sticks, 10);
obj_Chest.inventory.AddItem(global.vars.ItemLibrary.Cherry, 3);
obj_Chest.inventory.AddItem(global.vars.ItemLibrary.RawMeat, 5);
