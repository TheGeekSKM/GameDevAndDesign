...
event_inherited();
inventory.AddItem(global.vars.ItemLibrary.RAM, irandom_range(5, 10));
inventory.AddItem(global.vars.ItemLibrary.SandClumps, irandom_range(3, 7));
inventory.AddItem(global.vars.ItemLibrary.SteelDebris, irandom_range(1, 4));
inventory.AddItem(global.vars.ItemLibrary.ThermalGoo, irandom_range(5, 10));
inventory.AddItem(global.vars.ItemLibrary.CircuitBlade, irandom_range(1, 2));
inventory.AddItem(global.vars.ItemLibrary.GoldPlatedKnucles, irandom_range(1, 2));
inventory.AddItem(global.vars.ItemLibrary.AluminumPipe, irandom_range(1, 2));
inventory.AddItem(global.vars.ItemLibrary.SolderingIron, irandom_range(1, 2));
inventory.AddItem(global.vars.ItemLibrary.GrapheneWhip, irandom_range(1, 2));
inventory.AddItem(global.vars.ItemLibrary.CRTCannon, irandom_range(1, 2));
inventory.AddItem(global.vars.ItemLibrary.RAMStickThrower, irandom_range(1, 2));
inventory.AddItem(global.vars.ItemLibrary.CapacitorSlingshot, irandom_range(1, 2));
inventory.AddItem(global.vars.ItemLibrary.AntiStaticJumpsuit, irandom_range(1, 2));
inventory.AddItem(global.vars.ItemLibrary.GoldLinedCircuitVest, irandom_range(1, 2));
inventory.AddItem(global.vars.ItemLibrary.AluminumPlating, irandom_range(1, 2));
inventory.AddItem(global.vars.ItemLibrary.GrapheneWeaveSuit, irandom_range(1, 2));
inventory.AddItem(global.vars.ItemLibrary.Sticks, irandom_range(5, 15));
inventory.AddItem(global.vars.ItemLibrary.Cherry, irandom_range(1, 5));
inventory.AddItem(global.vars.ItemLibrary.RawMeat, irandom_range(3, 7));
