...
targets = [obj_Herbivore, obj_Carnivore, obj_Player, obj_Zombie];
...
function OnMouseLeftClick() {
    ...
    if (currentDialogue != undefined) {
        Raise("DialogueOpen", currentDialogue); 
    }
...
inventory.Equip(inventory.AddItem(global.vars.ItemLibrary.Bow));
inventory.Equip(inventory.AddItem(global.vars.ItemLibrary.Arrow));
