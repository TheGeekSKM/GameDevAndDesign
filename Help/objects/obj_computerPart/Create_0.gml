...
possibleParts = [
    new Item().SetName("GPU")
        ...
        .AddStatIncrease(new StatIncrease(AttributeType.Strength, irandom_range(1, 2), 10)),
    new Item().SetName("Motherboard")
        ...
        .SetWeight(3)
        .SetSprite(spr_pcParts)
        .AddStatIncrease(new StatIncrease(AttributeType.Constitution, irandom_range(1, 2), 10)),
    new Item().SetName("RAM Stick")
        ...
        .SetWeight(3)
        .SetSprite(spr_pcParts)
        .AddStatIncrease(new StatIncrease(AttributeType.Dexterity, irandom_range(1, 2), 10))
];
