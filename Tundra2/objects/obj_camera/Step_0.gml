...
switch (currentState)
{
    ...
    case CameraMode.FollowMousePeek: 
        cX = lerp(FollowingObject.x, mouse_x, 0.1) - (CamWidth / 2);
        cY = lerp(FollowingObject.y, mouse_y, 0.1) - (CamHeight / 2);
    break;
    ...
    case CameraMode.MoveToFollowTarget: 
        ...
        if (point_distance(cX, cY, FollowingObjext.x - (CamWidth / 2), FollowingObject.y - (CamHeight / 2)) < 1)
        {
