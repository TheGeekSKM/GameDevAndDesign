function Vars() constructor {
    ...
    CPU = new ConsumableItem("CPU", 1, 2, [new StatusEffects(StatType.Constitution, 2, 15)], spr_CPU);
    GPU = new ConsumableItem("GPU", 1, 2, [new StatusEffects(StatType.Strength, 2, 15)], spr_GPU);
    RAM = new ConsumableItem("RAM", 1, 2, [new StatusEffects(StatType.Dexterity, 2, 15)], spr_RAM);
}
