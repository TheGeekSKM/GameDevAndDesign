...
function StatSystem(_str, _dex, _con) constructor {
    ...
    function GetTemperatureRate() { return (max(0.5, 0.2 + (self.constitution * 0.1) - (self.strength * 0.05))) / 4; }

    function GetHungerRate() { return (max(0.5, 1 - (self.constitution * 0.1) + (self.strength * 0.05))) / 4; } 
